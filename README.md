...
### macOS ARM64
```
curl -L -o nimby https://github.com/treeform/nimby/releases/download/v0.1.6/nimby-macOS-ARM64
chmod +x nimby
```

### Linux X64
```
curl -L -o nimby https://github.com/treeform/nimby/releases/download/v0.1.6/nimby-Linux-X64
chmod +x nimby
```

### Windows
```
curl -L -o nimby.exe https://github.com/treeform/nimby/releases/download/v0.1.6/nimby-Windows-X64.exe
```
